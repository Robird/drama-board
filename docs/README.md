...
- [EventJournal + StateStore draft](research/event-journal-state-store-draft.md): selected paired roots, linear revision history, and event snapshots; editable API and implementation boundaries.
